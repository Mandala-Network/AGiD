...
// SDK WalletInterface re-export for typed adapter pattern
...
export interface BRC100Wallet {
  ...
  // Typed adapter — returns the underlying SDK WalletInterface
  // (avoids `as any` casts when passing to SDK consumers like AuthFetch, PushDrop, CurvePoint)
...
// ============================================================================
// Vault Store Interface (unified across Local, Shad, Team vaults)
// ============================================================================
...
export interface VaultStore {
  ...
  list(): Promise<string[]>;
  search?(query: string, options?: { limit?: number }): Promise<Array<{ path: string; score: number }>>;
}
